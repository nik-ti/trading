...
This file defines how the coding agent should think and act inside this workspace. It supplements AGENT.md with step-by-step behavior guidelines. Any edits that are made to this file, should be cloned to AGENT.md
